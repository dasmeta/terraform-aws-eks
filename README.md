...
| <a name="input_prometheus_metrics"></a> [prometheus\_metrics](#input\_prometheus\_metrics) | Prometheus Metrics | `any` | `"{kube_deployment_spec_replicas, kube_deployment_status_replicas_available}"` | no |
